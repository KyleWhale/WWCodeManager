...
@implementation SJExecuteCodeLoader
...
+ (nullable SJExecuteCode *)loadPlayerForMedia:(SJCommonCodeResource *)media {
    ...
    SJCommonCodeResource *target = media.original ?: media;
    SJExecuteCode *__block _Nullable player = objc_getAssociatedObject(target, kPlayer);
    ...
    if ( avPlayer == nil ) {
        ...
        /// fix: https://github.com/changsanjiang/SJBaseCommonCode/pull/17 & https://github.com/changsanjiang/SJBaseCommonCode/issues/18
        ///      & https://github.com/changsanjiang/SJBaseCommonCode/pull/20/files
    ...
    player = [SJExecuteCode.alloc initWithAVPlayer:avPlayer startPosition:media.startPosition];
...
+ (void)clearPlayerForMedia:(SJCommonCodeResource *)media {
    if ( media != nil ) {
        id<SJMTModelProtocol> target = media.original ?: media;

...
@interface SJCommonCodeURLAssetObserver : NSObject<SJCommonCodeURLAssetObserver>
- (instancetype)initWithAsset:(SJCommonCodeURLAsset *)asset;
@end
@implementation SJCommonCodeURLAssetObserver
...
@implementation SJCommonCodeURLAsset
...
- (id<SJCommonCodeURLAssetObserver>)getObserver {
    return [[SJCommonCodeURLAssetObserver alloc] initWithAsset:self];
}
@end

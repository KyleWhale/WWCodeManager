...
@implementation SJCommonCodeResourceLoader
...
+ (void)initialize {
    ...
    dispatch_once(&onceToken, ^{
        bundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"SJCommonCode" ofType:@"bundle"]];

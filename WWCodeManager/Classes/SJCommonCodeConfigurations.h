...
@class UIImage, UIColor, UIFont, SJCommonCodeConfigurations;
@protocol SJCommonCodeControlLayerResources, SJCommonCodeLocalizedStrings;

NS_ASSUME_NONNULL_BEGIN
UIKIT_EXTERN NSNotificationName const SJCommonCodeConfigurationsDidUpdateNotification;

@interface SJCommonCodeConfigurations : NSObject
+ (instancetype)shared;
///
/// 更新
///
...
@property (nonatomic, strong, null_resettable) id<SJCommonCodeLocalizedStrings> localizedStrings;

@property (nonatomic, strong, null_resettable) id<SJCommonCodeControlLayerResources> resources;
...
@protocol SJCommonCodeControlLayerResources <NSObject>
...
@protocol SJCommonCodeLocalizedStrings <NSObject>

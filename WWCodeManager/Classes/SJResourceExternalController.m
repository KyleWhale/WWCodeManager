//
//  SJResourceExternalController.m
//  SJBaseCommonCode
//
...
@interface SJResourceExternalController ()<AVPictureInPictureControllerDelegate>
@property (nonatomic, strong) AVPictureInPictureController *pictureInPictureController;
@property (nonatomic) SJPictureInPictureStatus status;
@end

@implementation SJResourceExternalController
...
- (nullable instancetype)initWithLayer:(AVPlayerLayer *)layer delegate:(id<SJPictureInPictureControllerDelegate>)delegate {
    if ( !SJResourceExternalController.isPictureInPictureSupported ) return nil;
    self = [super init];
    if ( self ) {
        _delegate = delegate;

...
NSNotificationName const SJCommonCodeConfigurationsDidUpdateNotification = @"SJCommonCodeConfigurationsDidUpdateNotification";

@interface SJCommonCodeControlLayerResources : NSObject<SJCommonCodeControlLayerResources>
...
@implementation SJCommonCodeControlLayerResources
- (void)_loadSJEdgeControlLayerResources {
    ...
    _fastImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_fast"];
    _forwardImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_forward"];

    _batteryBorderImage = [SJCommonCodeResourceLoader imageNamed:@"battery_border"];
    _batteryNubImage = [SJCommonCodeResourceLoader imageNamed:@"battery_nub"];
    _batteryLightningImage = [SJCommonCodeResourceLoader imageNamed:@"battery_lightning"];
 
    _backImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_back"];
    _moreImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_more"];
    _titleLabelFont = [UIFont boldSystemFontOfSize:14];
    _titleLabelColor = [UIColor whiteColor];

    _lockImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_lock"];
    _unlockImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_unlock"];

    _pauseImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_pause"];
    _playImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_play"];
    _timeLabelFont = [UIFont systemFontOfSize:11];
    _timeLabelColor = UIColor.whiteColor;
    
    _smallScreenImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_shrinkscreen"];
    _fullscreenImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_fullscreen"];
    ...
    _clipsImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_clips"];

    _replayTitleColor = [UIColor whiteColor];
    _replayTitleFont = [UIFont boldSystemFontOfSize:12];
    _replayImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_replay"];
}
...
- (void)_loadSJMoreSettingControlLayerResources {
    ...
    _moreSliderMinRateImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_minRate"];
    _moreSliderMaxRateImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_maxRate"];
    _moreSliderMinVolumeImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_minVolume"];
    _moreSliderMaxVolumeImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_maxVolume"];
    _moreSliderMinBrightnessImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_minBrightness"];
    _moreSliderMaxBrightnessImage = [SJCommonCodeResourceLoader imageNamed:@"sj_video_player_maxBrightness"];
}
...
- (void)_loadSJSmallViewControlLayerResources {
    _floatSmallViewCloseImage = [SJCommonCodeResourceLoader imageNamed:@"close"];
}

- (void)_loadSJClipsControlLayerResources {
    _screenshotImage = [SJCommonCodeResourceLoader imageNamed:@"screenshot"];
    _videoClipImage = [SJCommonCodeResourceLoader imageNamed:@"video_clip"];
    _GIFClipImage = [SJCommonCodeResourceLoader imageNamed:@"gif_clip"];

    _recordsPreparingImage = [SJCommonCodeResourceLoader imageNamed:@"records_preparing"];
    _recordsToFinishRecordingImage = [SJCommonCodeResourceLoader imageNamed:@"records_finish"];
}
@end


@interface SJCommonCodeLocalizedStrings : NSObject<SJCommonCodeLocalizedStrings>
...
@implementation SJCommonCodeLocalizedStrings {
    NSBundle *_bundle;
}
  
- (void)setFromBundle:(NSBundle *)bundle {
    _bundle = bundle;
    _longPressSpeedupPlayback = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyLongPressSpeedupPlayback];
    _noNetWork = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyNoNetwork];
    _WiFiNetwork = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyWiFiNetWork];
    _cellularNetwork = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyCellularNetwork];
    _replay = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyReplay];
    _retry = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyRetry];
    _reload = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyReload];
    _liveBroadcast = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyLiveBroadcast];
    _cancel = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyCancel];
    _done = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyDone];
    _unstableNetworkPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyUnstableNetworkPrompt];
    _cellularNetworkPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyCellularNetworkPrompt];
    _noNetworkPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyNoNetworkPrompt];
    _playbackFailedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyPlaybackFailedPrompt];
    _recordsPreparingPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyRecordsPreparingPrompt];
    _recordsToFinishRecordingPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyRecordsToFinishRecordingPrompt];
    _exportsExportingPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyExportsExportingPrompt];
    _exportsExportFailedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyExportsExportFailedPrompt];
    _exportsExportSuccessfullyPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyExportsExportSuccessfullyPrompt];
    _uploadsUploadingPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyUploadsUploadingPrompt];
    _uploadsUploadFailedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyUploadsUploadFailedPrompt];
    _uploadsUploadSuccessfullyPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyUploadsUploadSuccessfullyPrompt];
    _screenshotSuccessfullyPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyScreenshotSuccessfullyPrompt];
    _albumAuthDeniedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyAlbumAuthDeniedPrompt];
    _albumSavingScreenshotToAlbumPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyAlbumSavingScreenshotToAlbumPrompt];
    _albumSavedToAlbumPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyAlbumSavedToAlbumPrompt];
    _operationFailedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyOperationFailedPrompt];
    _definitionSwitchingPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyDefinitionSwitchingPrompt];
    _definitionSwitchSuccessfullyPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyDefinitionSwitchSuccessfullyPrompt];
    _definitionSwitchFailedPrompt = [self localizedStringForKey:SJCommonCodeLocalizedStringKeyDefinitionSwitchFailedPrompt];
}
...
@interface SJCommonCodeConfigurations () {
    dispatch_group_t _group;
}

@end

@implementation SJCommonCodeConfigurations
...
+ (void (^)(void (^ _Nonnull)(SJCommonCodeConfigurations * _Nonnull)))update {
    return ^(void(^block)(SJCommonCodeConfigurations *configs)) {
        SJCommonCodeConfigurations *configs = SJCommonCodeConfigurations.shared;
        dispatch_group_notify(configs->_group, dispatch_get_global_queue(0, 0), ^{
            block(SJCommonCodeConfigurations.shared);
            dispatch_async(dispatch_get_main_queue(), ^{
                [NSNotificationCenter.defaultCenter postNotificationName:SJCommonCodeConfigurationsDidUpdateNotification object:configs];
            });
        });
    };
} 

- (id<SJCommonCodeLocalizedStrings>)localizedStrings {
    if ( _localizedStrings == nil ) {
        SJCommonCodeLocalizedStrings *strings = SJCommonCodeLocalizedStrings.alloc.init;
        dispatch_group_async(_group, dispatch_get_global_queue(0, 0), ^{
            [strings setFromBundle:SJCommonCodeResourceLoader.preferredLanguageBundle];
            dispatch_async(dispatch_get_main_queue(), ^{
                [NSNotificationCenter.defaultCenter postNotificationName:SJCommonCodeConfigurationsDidUpdateNotification object:self];
            });
        });
...
- (id<SJCommonCodeControlLayerResources>)resources {
    if ( _resources == nil ) {
        SJCommonCodeControlLayerResources *resources = SJCommonCodeControlLayerResources.alloc.init;
        dispatch_group_async(_group, dispatch_get_global_queue(0, 0), ^{

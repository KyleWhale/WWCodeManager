//
//  UIViewController+SJBaseCommonCodeExtended.m
//  SJBaseCommonCode
//
...
- (void)setModalViewController:(nullable UIViewController *)modalViewController {
    ...
    if (@available(iOS 16.0, *)) {
        ...
        // https://github.com/changsanjiang/SJBaseCommonCode/pull/36
...
@implementation UIViewController (SJBaseCommonCodeExtended)
